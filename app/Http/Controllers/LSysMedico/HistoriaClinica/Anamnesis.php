...
class Anamnesis extends Controller
{
    ...
    /**
     *
     * estadistica de tipo de enfermedades comunes por fechas
     *
     */
    public function data_enfermedadesfamiliares_filtro($texto)
    {
        $data_user=Session::get('user_data');
        $id_emp=$data_user[0]->persona->personaempresa[0]->id_emp;
    ...
    /**
     *
     * estadistica de diagnosticos por fechas
     *
     */
    public function data_diagnosticos_filtro($texto)
    {
        $data_user=Session::get('user_data');
        $id_emp=$data_user[0]->persona->personaempresa[0]->id_emp;
