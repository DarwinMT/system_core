<div class="row" ng-init="permisos_user();" ng-cloak>
		...
		<div class="row">
			<div class="col-md-1 col-xs-6">
				<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">
				    <li ng-hide=" list_permisos.access_excell==0 " ng-click="excell_Ciudad();" ><a href=""><i class="glyphicon glyphicon-th"></i> Excell</a></li>
			...
			<div class="col-md-4 col-xs-6">
				<div class="form-group has-feedback">
				    <input type="text" class="form-control input-sm" id="buscartexto" name="buscartexto" ng-model="buscartexto" ng-keyup="initLoad(1)" placeholder="Buscar Ciudades">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 table-responsive">
				<table class="table table-bordered table-condensend" >
					...
					<tbody>
						<tr dir-paginate="r in list_Ciudad | orderBy:sortKey:reverse |filter:buscartexto| itemsPerPage:5" total-items="totalItems" ng-cloak">
							<td>{{$index+1}}</td>
							<td>{{r.descripcion}}</td>
							<td>{{r.provincia.descripcion}}</td>
							<td>{{r.provincia.pais.descripcion}}</td>
	...
	<div style="display: none;">
		<table id="list_country">
			...
			<tbody>
				<tr ng-repeat="e in list_Ciudad_excell">
					<td>{{$index+1}}</td>
					<td>{{e.descripcion}}</td>
					<td>{{e.provincia.descripcion}}</td>
					<td>{{e.provincia.pais.descripcion}}</td>
	...
	<form class="form-horizontal"  name="frmciudad" id="frmciudad"  novalidate="">
	
		<div class="row">
			<div class="col-md-6 col-xs-12">
				<div class="input-group">
				  <span class="input-group-addon" id="basic-addon1"> País</span>
				  <select  class="form-control input-sm" id="id_pa" name="id_pa" ng-model="id_pa" ng-change="loadprovincia(id_pa)"  required >
				  		<option value="">Seleccione</option>
				  		<option ng-repeat=" p in list_pais " value="{{p.id_pa}}">{{p.descripcion}}</option>
				  </select>
				</div>
				<span class="help-block error" ng-show="frmciudad.id_pa.$invalid && frmciudad.id_pa.$touched">El pais es requerido</span>
			</div>
			<div class="col-md-6 col-xs-12">
				<div class="input-group">
				...
				<span class="help-block error" ng-show="frmciudad.id_pro.$invalid && frmciudad.id_pro.$touched">La provincia es requerida</span>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 col-xs-6">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1">Descriopción Ciudad: </span>
					<input type="text" class="form-control input-sm" name="descripcion" id="nombre" ng-model="descripcion" required />
				</div>
				<span class="help-block error" ng-show="frmciudad.descripcion.$invalid && frmciudad.descripcion.$touched">El nombre del país es requerido</span>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 text-center">
				<div class="btn-group" role="group" aria-label="...">
					<button ng-hide=" newedid!='1' "  ng-show=" newedid=='1' "  ng-disabled=" list_permisos.access_save==0 || frmciudad.$invalid  " type="button" class="btn btn-sm btn-success" ng-click=" save(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>

					<button ng-hide=" newedid!='2' "  ng-show=" newedid=='2' "  ng-disabled=" list_permisos.access_edit==0 || frmciudad.$invalid " type="button" class="btn btn-sm btn-info" ng-click=" edit(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>
