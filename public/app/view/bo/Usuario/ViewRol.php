<div class="row" ng-init="permisos_user();" ng-cloak>
	...
	<!--Registro-->
	<div ng-hide=" neweditrol!='0' " ng-show=" neweditrol=='0' " >
		...
		<div class="row">
			<div class="col-md-1 col-xs-6">
				<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">
				    <li ng-hide=" list_permisos.access_excell==0 " ng-click="excell_rol();" ><a href=""><i class="glyphicon glyphicon-th"></i> Excell</a></li>
			...
			<div class="col-md-4 col-xs-6">
				<div class="form-group has-feedback">
				    <input type="text" class="form-control input-sm" id="buscartexto" name="buscartexto" ng-model="buscartexto" ng-keyup="initLoad(1)" placeholder="Buscar Rol">
			...
			<div class="col-md-2 col-xs-6">
				<button ng-disabled=" list_permisos.access_ready==0 " type="button" class="btn btn-sm btn-primary" ng-click=" neweditrol='1'; ">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 table-responsive">
				<table class="table table-bordered table-condensend" >
					...
					<tbody>
						<tr dir-paginate="r in list_roles | orderBy:sortKey:reverse |filter:buscartexto| itemsPerPage:5" total-items="totalItems" ng-cloak">
							<td>{{$index+1}}</td>
							<td>{{r.descripcion}}</td>
	...
	<div style="display: none;">
		<table id="list_rol">
			...
			<tbody>
				<tr ng-repeat="e in list_roles_excell">
					<td>{{$index+1}}</td>
					<td>{{e.descripcion}}</td>
	...
	<form class="form-horizontal"  name="rol_system" id="rol_system"  novalidate="">
		...
		<div class="row">
			<div class="col-md-6 col-xs-6">
				<div class="input-group">
					<span class="input-group-addon" id="basic-addon1">Descriopción Rol: </span>
					<input type="text" class="form-control input-sm" name="descripcion" id="nombre" ng-model="descripcion" required />
				</div>
				<span class="help-block error" ng-show="rol_system.descripcion.$invalid && rol_system.descripcion.$touched">El rol es requerido</span>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 text-center">
				<div class="btn-group" role="group" aria-label="...">
					<button ng-hide=" neweditrol!='1' "  ng-show=" neweditrol=='1' "  ng-disabled=" list_permisos.access_save==0 || rol_system.$invalid  " type="button" class="btn btn-sm btn-success" ng-click=" save(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>

					<button ng-hide=" neweditrol!='2' "  ng-show=" neweditrol=='2' "  ng-disabled=" list_permisos.access_edit==0 || rol_system.$invalid " type="button" class="btn btn-sm btn-info" ng-click=" edit(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>

					<button type="button" class="btn btn-sm btn-primary" ng-click=" neweditrol='0'; clear();">
