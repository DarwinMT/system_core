<div class="row" ng-init="permisos_user();" ng-cloak>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 table-responsive">
				<table class="table table-bordered table-condensend" >
					...
					<tbody>
						<tr dir-paginate="r in list_cargos | orderBy:sortKey:reverse |filter:buscartexto| itemsPerPage:5" total-items="totalItems" ng-cloak">
							<td>{{$index+1}}</td>
							<td>{{r.descripcion}}</td>
	...
	<div style="display: none;">
		<table id="list_rol">
			...
			<tbody>
				<tr ng-repeat="e in list_cargos_excell">
					<td>{{$index+1}}</td>
					<td>{{e.descripcion}}</td>
	...
	<form class="form-horizontal"  name="cargo_system" id="cargo_system"  novalidate="">
		...
		<div class="row">
			<div class="col-md-6 col-xs-6">
				...
				<span class="help-block error" ng-show="cargo_system.descripcion.$invalid && cargo_system.descripcion.$touched">El cargo es requerido</span>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 text-center">
				<div class="btn-group" role="group" aria-label="...">
					<button ng-hide=" neweditrol!='1' "  ng-show=" neweditrol=='1' "  ng-disabled=" list_permisos.access_save==0 || cargo_system.$invalid  " type="button" class="btn btn-sm btn-success" ng-click=" save(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>

					<button ng-hide=" neweditrol!='2' "  ng-show=" neweditrol=='2' "  ng-disabled=" list_permisos.access_edit==0 || cargo_system.$invalid " type="button" class="btn btn-sm btn-info" ng-click=" edit(); ">
						<i class="glyphicon glyphicon-floppy-saved"></i> Guardar
					</button>
