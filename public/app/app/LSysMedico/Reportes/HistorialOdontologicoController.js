app.controller('LogicaHistorialOdontologico', function($scope, $http, API_URL,Upload) {
    $scope.Title="Historial Clínico Odontologico Cliente";
    ...
    $scope.permisos_user=function () {
        $http.get(API_URL + 'RegOdontologia')
    ...
    $scope.initLoad = function(pageNumber){
        ...
        $http.get(API_URL + 'RegOdontologia/get_paciente_historia_odontologica?page=' + pageNumber + '&filter=' + JSON.stringify(filtros))
    ...
    $scope.excell_Historia=function(){
        ...
        $scope.list_Historia_excell=[];
        $http.get(API_URL + 'RegOdontologia/get_medicamentos/' + JSON.stringify(filtros))
            .then(function(response){
    ...
    $scope.get_dataanamanesis=function (pageNumber) {
       ...
       $http.get(API_URL + 'RegOdontologia/get_listanamnesis_cliente_odontologia?page=' + pageNumber + '&filter=' + JSON.stringify(filtros))
            .then(function(response){
                console.log(response.data.data);
